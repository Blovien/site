...
Hytale usa **Blockbench** como herramienta primera para modelado 3D y animaciones:
...
* **Reemplaza herramientas de legado**: Completamente reemplaza el viejo Creador de Modelos de Hytale para apoyar mejor el flujo creativo de la comunidad.
...
La gran mayoría de modelos en Hytale son limitados a principios geométricos específicos:
...
* **Sin Restricciones Estrictas**: Relacion entre pixeles, rotación y escalado no estan restringidos
...
* **Edición de Recursos de Datos**: Editor primario para trabajar con Recursos de Datos
...
* **Creación Interna**: Partículas son creadas directamente en el juego usando el Editor de Recursos
