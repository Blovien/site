...
Hytale strongly recommends Visual Scripting since it is both more accessible and safer to share and download. Однако полностью работать на Java всё равно будет возможно для тех, кому это предпочтительнее.
